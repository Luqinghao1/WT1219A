...
void ModelWidget2::onExportData() {
    ...
    QString path = QFileDialog::getSaveFileName(this, "导出CSV数据", defaultDir + "/Model2_Data.csv", "CSV Files (*.csv)");
...
void ModelWidget2::onExportImage() {
    ...
    QString path = QFileDialog::getSaveFileName(this, "导出图表图片", defaultDir + "/Model2_Chart.png", "PNG Image (*.png);;JPEG Image (*.jpg);;PDF Document (*.pdf)");
    if (path.isEmpty()) return;
    bool success = false;
